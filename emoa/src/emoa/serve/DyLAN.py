...
from emoa.core.DyLAN_app import DyLANAPP
# ----------------
...
from emoa.router.src.models.routerdc import RouterModule
import torch
    ...
    def __init__(
        ...
        if config["mode"] == "moa":
            ...
            if config["router_type"] == "normal":
                ...
                model = MatrixFactorizationRouter(router_backbone, num_labels)  # todo: configurable models
                ...
                self.router = RouterModule(
                    ...
                    node_size=10,      #here has been modified at May 14th 00:30
    ...
    def setup_routes(self):
        ...
        async def process_message(request: ChatCompletionRequest):
            ...
            try:
                ...
                logger.info(f"{json_compatible_item_data=}")
                # breakpoint()
